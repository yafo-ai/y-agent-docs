...
```bash
# SFT训练（单卡，LoRA）
--training_type sft --use_lora --batch_size 1 --token_batch 12

# CPT训练（多卡，全量）
--training_type cpt --use_deepspeed --batch_size 2 --pack_length 2048

# 高级配置（NLIRG + TensorBoard）
--use_NLIRG --use_tensorboard --checkpoint_epoch '0,1'
```

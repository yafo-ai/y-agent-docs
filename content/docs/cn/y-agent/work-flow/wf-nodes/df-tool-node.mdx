...
<Accordion title="流程日志查询" id="flow-node-logs">
工具名称：		
flow_node_logs 流程日志查询

<include>../public/query-flow-logs.mdx</include>
...
<Accordion title="如何显示引用文档" id="show-ref-docs">
...
<include>../public/sys-webapi.mdx</include>
![](../imgs/add-inner-api-tool.png)
